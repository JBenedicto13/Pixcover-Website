...
?>
    ...
    <div class="col col-body">
        ...
        <div class="d-flex mb-3">
            <div class="p-2">
                <a href="<?php echo 'profile-visit.php?uid='.$ROW['creator_id']?>" class="nav-link"><img id="avatar_pic" src="<?php echo '../accounts/avatars/'.$ROW['display_photo']; ?>" alt=""></a>
            </div>
            <div class="p-2">
                <div class="row"><h5><a class="nav-link" href="<?php echo 'profile-visit.php?uid='.$ROW['creator_id']?>"><?php echo $ROW['fname']." ".$ROW['lname']; ?></a></h5></div>
